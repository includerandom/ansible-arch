...
-- beautiful.init( awful.util.getdir("config") .. "/home/factor/.config/awesome/themes/default/theme.lua" )
...
--    batterywidget:set_text(batterInofo("BAT2"))
end)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    tags = {
      names  = { "cmd", "web", "edit", "git", "etc", "chat", "fm", "other" },
      layout = { layouts[1], layouts[2], layouts[1],layouts[1], layouts[1], layouts[1], layouts[1], layouts[1]
    }}
...
--        awful.util.spawn("scrot -e 'mv $f ~/screenshots/ 2>/dev/null'", false) end),
        awful.util.spawn("/usr/bin/flameshot gui", false) end),
...
--  awful.key({ }, "XF86Suspend", function ()
    ...
    awful.key({}, "XF86AudioMicMute",
      function () awful.util.spawn("amixer set Capture toggle") end),
